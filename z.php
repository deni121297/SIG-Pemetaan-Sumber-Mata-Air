<!DOCTYPE html><html><head>
	<title>haversine map</title><head>
...
<div id='map' ></div>
<div id="inputs">
<button id="SSN_I" style="width: 150px;">sumur sonean I</button><br>
<button id="SSN_II" style="width: 150px;">sumur sonean II</button><br>
<button id="MAK" style="width: 150px;">mata air kayen</button><br>
<button id="STL"style="width: 150px;">sumur trangkil</button><br>
<button id="SSK"style="width: 150px;">sumur Swaduk </button><br>
<button id="SKN"style="width: 150px;">sumur Kecanen </button><br>
<button id="MAL"style="width: 150px;">mata air lumbungmas</button><br>
<button id="SWO"style="width: 150px;">sumur wonorejo</button><br>
<button id="SSO"style="width: 150px;">sumur sambi rejo</button><br>
<button id="SS_I"style="width: 150px;">sumur sani I</button><br>
<button id="SS_II"style="width: 150px;">sumur sani II</button><br>
<button id="STI"style="width: 150px;">sumur tamansari</button><br>
<button id="SRT"style="width: 150px;">sumur rendole timur</button><br>
<button id="SRB"style="width: 150px;">sumur rendole barat</button><br>
<button id="SSTO"style="width: 150px;">sumur sidokerto</button><br>
<button id="SSO_I"style="width: 150px;">sumur sugiharjo I</button><br>
<button id="SSO_II"style="width: 150px;">sumur sugiharjo II</button><br>
<button id="SSO_III"style="width: 150px;">sumur sugiharjo III</button><br>
<button id="SSO_IV"style="width: 150px;">sumur sugiharjo IV</button><br>
<button id="WTP"style="width: 150px;">wtp</button>

</div>
<div id="judul">
	<p style="font-size: 14px;"><center><b>Haversine</b></center></p>
</div>

<div id="haver">
	
<button id="home" style="width: 100px;" >zoom out</button><br>
<button onclick="beranda()" style="width: 100px;">manual book</button><br>
<form action="direction.php">
<button style="width: 100px;">direction</button><br>
</form>
</div>
